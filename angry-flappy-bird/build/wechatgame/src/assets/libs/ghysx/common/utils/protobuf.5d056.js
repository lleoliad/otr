    ...
    function Codegen(formatStringOrScope) {
        ...
        if (typeof formatStringOrScope !== "string") {
            ...
            if (formatStringOrScope) {
                ...
                // var ttfun = null; // Function.apply(null, scopeParams).apply(null, scopeValues); // eslint-disable-line no-new-func
                // if (source.indexOf('Message$encode') > -1) {
                //     let Writer = formatStringOrScope.Writer;
                //     let types = formatStringOrScope.types;
                //     let util = formatStringOrScope.util;
                //     ttfun = function Message$encode(m, w) {
                //         if (!w)
                //             w = Writer.create()
                //         if (m.gate != null && m.hasOwnProperty("gate"))
                //             w.uint32(10).string(m.gate)
                //         if (m.handler != null && m.hasOwnProperty("handler"))
                //             w.uint32(18).string(m.handler)
                ...
                //             w.uint32(42).string(m.event)
                //         if (m.invoke != null && m.hasOwnProperty("invoke"))
                //             w.uint32(50).string(m.invoke)
                //         if (m.data != null && m.hasOwnProperty("data"))
                //             w.uint32(58).string(m.data)
                //         w.uint32(64).uint64(m.time)
                //         return w
                //     }
                // } else if (source.indexOf('Message$decode') > -1) {
                //     let Reader = formatStringOrScope.Reader;
                //     let types = formatStringOrScope.types;
                //     let util = formatStringOrScope.util;
                //     ttfun = function Message$decode(r, l) {
                ...
                //             throw util.ProtocolError("missing required 'time'", {
                //                 instance: m
                //             })
                //         return m
                //     }
                // } else if (source.indexOf('Message$verify') > -1) {
                //     let types = formatStringOrScope.types;
                //     let util = formatStringOrScope.util;
                //     ttfun = function Message$verify(m) {
                //         if (typeof m !== "object" || m === null)
                //             return "object expected"
                //         if (m.gate != null && m.hasOwnProperty("gate")) {
                //             if (!util.isString(m.gate))
                //                 return "gate: string expected"
                //         }
                //         if (m.handler != null && m.hasOwnProperty("handler")) {
                //             if (!util.isString(m.handler))
                //                 return "handler: string expected"
                //         }
                //         if (!util.isInteger(m.status))
                //             return "status: integer expected"
                //         if (m.info != null && m.hasOwnProperty("info")) {
                //             if (!util.isString(m.info))
                //                 return "info: string expected"
                //         }
                //         if (m.event != null && m.hasOwnProperty("event")) {
                //             if (!util.isString(m.event))
                //                 return "event: string expected"
                //         }
                //         if (m.invoke != null && m.hasOwnProperty("invoke")) {
                //             if (!util.isString(m.invoke))
                //                 return "invoke: string expected"
                //         }
                //         if (m.data != null && m.hasOwnProperty("data")) {
                //             if (!util.isString(m.data))
                //                 return "data: string expected"
                //         }
                //         if (!util.isInteger(m.time) && !(m.time && util.isInteger(m.time.low) && util.isInteger(m.time.high)))
                //             return "time: integer|Long expected"
                //         return null
                //     }
                // } else if (source.indexOf('Message$fromObject') > -1) {
                //     let types = formatStringOrScope.types;
                //     let util = formatStringOrScope.util;
                //     ttfun = function Message$fromObject(d) {
                //         if (d instanceof this.ctor)
                //             return d
                //         var m = new this.ctor
                //         if (d.gate != null) {
                //             m.gate = String(d.gate)
                //         }
                //         if (d.handler != null) {
                ...
                //         return m
                //     }
                // } else if (source.indexOf('Message$toObject') > -1) {
                //     let types = formatStringOrScope.types;
                //     let util = formatStringOrScope.util;
                //     ttfun = function Message$toObject(m, o) {
                //         if (!o)
                //             o = {}
                //         var d = {}
                //         if (o.defaults) {
